...
public class Group_Column {
     ...
     */    
    public Group_Column(String text) {
        this(null,text);
    }
     ...
     * when the ColumnGroup is renderered.
     */    
    public Group_Column(TableCellRenderer renderer,String text) {
        if (renderer == null) {
    ...
    public Vector getColumnGroups(TableColumn c, Vector g) {
        ...
        while (iter.hasNext()) {
            ...
            if (obj instanceof Group_Column) {
                Vector groups =
                (Vector)((Group_Column)obj).getColumnGroups(c,(Vector)g.clone());
    ...
    public Dimension getSize(JTable table) {
        ...
        while (iter.hasNext()) {
            ...
            if (obj instanceof TableColumn) {
                ...
                width += ((Group_Column)obj).getSize(table).width;
            }
        }
    ...
    public void setColumnMargin(int margin) {
        ...
        while (iter.hasNext()) {
            Object obj = iter.next();
            if (obj instanceof Group_Column) {
                ((Group_Column)obj).setColumnMargin(margin);
            }
        }
    }
}
