 ...
 */
public class Group_TableColumnModel extends DefaultTableColumnModel {
     ...
     */    
    public void addGroupColumn(Group_Column columnGroup) {
     ...
     * @return ColumnGroup
     */    
    public Group_Column getColumnGroup(int index) {
        if(index >= 0 && index < columnGroups.size()) {
            return (Group_Column)columnGroups.get(index);
        }
        return null;
    }
