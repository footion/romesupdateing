 ...
 */
public class Group_TableHeaderUI extends BasicTableHeaderUI {
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        Group_TableColumnModel cm = (Group_TableColumnModel)header.getColumnModel();
        if (cm == null) return;
        ((Group_TableHeader)header).setColumnMargin();
        int column = 0;
        ...
        while (columns.hasMoreElements()) {
            ...
            if (colGrpIter != null) {
                ...
                while (colGrpIter.hasNext()) {
                    Group_Column cGroup = (Group_Column)colGrpIter.next();
     ...
     */    
    private void paintCell(Graphics g, Rectangle cellRect,Group_Column cGroup) {
    ...
    private int getHeaderHeight() {
        int height = 0;
        Group_TableColumnModel columnModel = (Group_TableColumnModel)header.getColumnModel();
