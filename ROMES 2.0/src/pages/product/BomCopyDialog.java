...
public class BomCopyDialog extends JDialog {
	 ...
	 */
	public BomCopyDialog(FormUpdatePage formUpdatePage) {
								...
								FormSpecs.RELATED_GAP_ROWSPEC, RowSpec.decode("bottom:default"), }));
		{
			...
			{
				JLabel lblNewLabel = new JLabel("BOM 정보 복사");
		...
		{
			ColoredPanel panel = new ColoredPanel();
			contentPanel.add(panel, "2, 4, 1, 3, fill, fill");
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						formUpdatePage.sendDataToCopyBom(selectedProductPkey);
